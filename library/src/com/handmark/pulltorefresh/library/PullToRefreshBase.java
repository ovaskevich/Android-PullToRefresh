...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    /**
     * Used internally for adding view. Need because we override addView to pass-through to the Refreshable
     * View
     */
    ...
    /**
     * Used internally for {@link #getLoadingLayoutProxy(boolean, boolean)}. Allows derivative classes to
     * include any extra LoadingLayouts.
     */
    ...
    /**
     * This is implemented by derived classes to return the created View. If you need to use a custom View
     * (such as a custom ListView), override this method and return an instance of your custom class.
     * <p/>
    ...
    /**
     * Implemented by derived class to return whether the View is in a state where the user can Pull to
     * Refresh by scrolling from the end.
     * 
    ...
    /**
     * Implemented by derived class to return whether the View is in a state where the user can Pull to
     * Refresh by scrolling from the start.
     * 
    ...
    /**
     * Called by {@link #onRestoreInstanceState(Parcelable)} so that derivative classes can handle their saved
     * instance state.
     * 
    ...
    protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        /**
         * As we're currently in a Layout Pass, we need to schedule another one to layout any changes we've
         * made here
         */
        post(new Runnable() {
            @Override
    ...
    /**
     * Updates the View State when the mode has been set. This does not do any checking that the mode is
     * different to current state so always updates.
     */
    ...
    public static enum AnimationStyle {
        ...
        /**
         * Maps an int to a specific mode. This is needed when saving state, or inflating the view from XML
         * where the mode is given through a attr int.
         * 
    ...
    public static enum Mode {
        ...
        /**
         * Only allow the user to Pull from the start of the Refreshable View to refresh. The start is either
         * the Top or Left, depending on the scrolling direction.
         */
        PULL_FROM_START(0x1),

        /**
         * Only allow the user to Pull from the end of the Refreshable View to refresh. The start is either
         * the Bottom or Right, depending on the scrolling direction.
         */
        PULL_FROM_END(0x2),
    ...
    /**
     * Listener that allows you to be notified when the user has started or finished a touch event. Useful
     * when you want to append extra UI events (such as sounds). See (
    ...
    public static interface OnPullEventListener<V extends View> {
         ...
         *            which direction the user is pulling. Only useful when <var>state</var> is
    ...
    /**
     * An advanced version of the Listener to listen for callbacks to Refresh. This listener is different as
     * it allows you to differentiate between Pull Ups, and Pull Downs.
     * 
     * @author Chris Banes
     */
    ...
    public static enum State {
        ...
        /**
         * When the UI is being pulled by the user, but has not been pulled far enough so that it refreshes
         * when released.
         */
        PULL_TO_REFRESH(0x1),

        /**
         * When the UI is being pulled by the user, and <strong>has</strong> been pulled far enough so that it
         * will refresh when released.
         */
